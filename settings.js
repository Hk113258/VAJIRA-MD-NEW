...
module.exports = {
SESSION_ID: process.env.SESSION_ID === VAJIRA-MD=SZMD1DaB#HGJkqBMx4Mjinbs4AlYWc_qd8Y6PJX_YveXcENhmYNA '' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === 923288744355 '' : process.env.OWNER_NUMBER,   
